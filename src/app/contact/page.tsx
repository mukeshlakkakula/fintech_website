    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 overflow-x-hidden">
        <GlassHero 
          ...
          subtitle="Get in touch with our experts to discuss your fintech and wealth management needs."
        />
                ...
                <div className="space-y-10 mb-16">
                  <div className="flex items-start gap-6 group">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-medium text-foreground leading-relaxed max-w-xs">
                        Level 15, Platina, G-Block, Bandra Kurla Complex (BKC), Mumbai, Maharashtra - 400051
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-6 group">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-medium text-foreground">+91 22 6677 8899</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-6 group">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-medium text-foreground">advisory@elitefintech.com</p>
                    </div>
                  </div>
                </div>
