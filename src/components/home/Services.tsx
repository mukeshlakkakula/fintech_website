...
import { Banknote, BarChart3, ShieldAlert, ArrowRight } from "lucide-react";
import Link from "next/link";

const services = [
  {
    title: "Digital Banking",
    description: "Modernizing financial infrastructure with secure, scalable digital banking platforms and seamless integrations.",
    icon: Banknote,
  },
  {
    title: "Algorithmic Trading",
    description: "High-frequency trading systems and algorithmic strategies designed for maximum efficiency and market impact.",
    icon: BarChart3,
  },
  {
    title: "Financial Risk",
    description: "Advanced risk modeling and compliance frameworks to protect assets and ensure regulatory adherence globally.",
    icon: ShieldAlert,
  },
];
